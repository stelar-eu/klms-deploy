...

{
  env(config): {
    ...
    KEYCLOAK_REALM: system_pim.keycloak.REALM,
    KEYCLOAK_DOMAIN_NAME: config.endpoint.SCHEME + "://" + config.endpoint.KEYCLOAK_SUBDOMAIN + "." + config.endpoint.ROOT_DOMAIN,
    KEYCLOAK_PORT: std.toString(system_pim.ports.KEYCLOAK),
    KC_API_CLIENT_NAME: system_pim.keycloak.KC_API_CLIENT_NAME,
    KC_MINIO_CLIENT_NAME: system_pim.keycloak.KC_MINIO_CLIENT_NAME,
    KC_CKAN_CLIENT_NAME: system_pim.keycloak.KC_CKAN_CLIENT_NAME,
