// Static registry for lib2 components and their entrypoints.
{
  ...
  local entrypoints = {
    ...
    airflow: import "../airflow/entrypoint.libsonnet",
    previewer: import "../previewer/entrypoint.libsonnet",
    sde: import "../sde/entrypoint.libsonnet",
    visualizer: import "../visualizer/entrypoint.libsonnet",
